...
troll_tweets_left <- read.csv("IRAhandle_tweets_5.csv") #seems to be imitating the far left
troll_tweets_right <- read.csv("IRAhandle_tweets_8.csv") #seems to be imitating Trump supporters
```
